$(document).ready(function(){
    ...
    $(window).on('resize',function(){
        ...
        if(num<=767){
            // 모바일이미지로 교체
            $('header button').hide()
            $('main .slider .slide1 img').attr('src','./original/m_athlet_day.jpg')
            $('main .slider .slide2 img').attr('src','./original/m_banner.jpg')
            $('main .slider .slide3 img').attr('src','./original/m_pants_day.jpg')
            ...
            $('main .slider .slide1 img').attr('src','./original/athlet_day.jpg')
            $('main .slider .slide2 img').attr('src','./original/banner.jpg')
            $('main .slider .slide3 img').attr('src','./original/pants_day.jpg')
